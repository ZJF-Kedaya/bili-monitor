...
"</head>",
"<body>",
"<header><div class=\"header-inner\"><h1>📡 B站UP主监控 <span class=\"ver\">v1.1</span></h1><p class=\"sub\">UP主更新监控 · 视频解析下载</p></div><nav class=\"tabs\"><button class=\"tab active\" id=\"tab-monitor\" onclick=\"switchPage('monitor')\">监控</button><button class=\"tab\" id=\"tab-parser\" onclick=\"switchPage('parser')\">视频解析下载</button></nav></header>",
